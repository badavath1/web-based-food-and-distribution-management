...
DEBUG = True
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "web-based-food-and-distribution.onrender.com"]
...
ROOT_URLCONF = 'food_donation_system.urls'
...
WSGI_APPLICATION = 'food_donation_system.wsgi.application'
